                                                ...
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $p->name }}  </td><td  style="position:absolute; right:20px;">{{date("d-m-Y h:m:s", strtotime($p->added_at))}}</td>
                                                ...
                                                <table class="mb-4">
                                                    <tr>
                                                        ...
                                                        <td>@if($uQA->fname != "")
                                                            ...
                                                            <p>Partner Name : {{$uQA->partner_fname}}
                                                                {{$uQA->partner_lname}}</p> -->
                                                            @endif
                                                        ...
                                                        @if($uQA->packg_for == 1)
                                                         ...
                                                         @else
                                                                       <td>
                                                            @if($uQA->status == 0)
                                                          <p>  <a href="{{url('coach/response/'.$uQA->id)}}"
