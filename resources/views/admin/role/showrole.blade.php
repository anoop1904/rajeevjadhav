							...
							<table class="table mb-5">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<!--<a href='destroyquestions/{{ $data->id }}'><span class="svg-icon svg-icon-primary svg-icon-2x">-->
											...
											<a href="{{url('admin/delete/'.$data->id)}}" onclick="return confirm('Are you sure?')"><span class="svg-icon svg-icon-danger svg-icon-2x">
