						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<!--begin::User-->	
								@if (Route::has('login'))
										...
										@else										
											<div class="topbar-item">
											<a href="{{ url('/admin') }}" class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2">										
    ...
    <div class="row m-0" style="position: absolute; width:100%; top:50%; transform:translateY(-50%);">
      ...
      <div class="card p-5">
            ...
            <div class="login-signin text-center">
                ...
                <form method="POST" action="{{ url('login_coach') }}">
                 @csrf
                    <div class="form-group mb-5">
                    <input class="form-control h-auto form-control-solid py-4 px-8" type="email" placeholder="Email" name="email" value="{{old('email')}}"/>
			        </div>
                    <div class="form-group mb-5">
                    ...
                    <div class="form-group d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <a href="{{ url('/coach/forgot_password') }}" id="kt_login_forgot" class="text-muted text-hover-primary">Forget Password ?</a>
                    </div>
