                            ...
                            @if($role)
                                ...
                                <form method="post" action="{{ route('store_coach') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control form-control-lg form-control-solid" name="email" value="{{ old('email') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <input class="form-control form-control-lg form-control-solid" type="text" name="qualification" value="{{ old('qualification') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <input class="form-control form-control-lg form-control-solid" type="text" name="expertise" value="{{ old('expertise') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            @error('coach_type') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <input class="btn btn-Primary" type="submit" value="submit coach">
                                </form>
                                @else 
