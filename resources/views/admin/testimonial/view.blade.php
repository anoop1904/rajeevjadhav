                                    ...
                                    <div class="card card-custom gutter-b card-stretch">
                                        ...
                                        <div class="card-body pt-4">
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                ...
                                                <div class="flex-shrink-0 mr-4 mt-lg-0 mt-3">
                                                    <div class="symbol symbol-lg-75">
                                                        <img alt="Pic" src="../storage/app/{{$data->photo}}" />
                                                    </div>
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="text-muted font-weight-bold">{{$data->type}}</span>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::User-->
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                ...
                                                <iframe width="560" style="width: 100%;" height="250" src="{{$data->link}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                ...
                                                <iframe width="560" style="width: 100%;" height="250" src="../storage/app/{{$data->video}}" title="video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
