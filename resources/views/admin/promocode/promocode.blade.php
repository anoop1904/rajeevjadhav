					...
					<div class="card-header">
						...
						<div class="card-toolbar">
							<div class="example-tools justify-content-center">
								<a href="{{url('/admin/add-promocode')}}"class="btn btn-light-warning font-weight-bolder btn-sm">Add New</a>
							</div>
						</div>
					</div>
					<!--begin::Form-->
								...
								<table class="table mb-5">
									...
									<tbody>@if($data)
										...
										<tr>
											...
											<td>{{$pdata->name}}</td>
											<td>{{$pdata->amount}} {{$pdata->type}}</td>
                                            <td>{{$pdata->startdate}}</td>
                                            <td>{{$pdata->enddate}}</td>

											
											<td>
												<a href='edit-promocode/{{ $pdata->id }}'><span class="svg-icon svg-icon-primary svg-icon-2x">
												...
												|<a href='delete-promocode/{{ $pdata->id }}'><span class="svg-icon svg-icon-danger svg-icon-2x">
