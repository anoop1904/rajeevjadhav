			...
			<div class="col-lg-12">
				...
				<div class="card card-custom gutter-b example example-compact">
					<div class="card-header">
						...
						<h3 class="card-title">{{$row->name}} Questions</h3>
						...
						<div class="card-toolbar">
							<div class="example-tools justify-content-center">
								<a href="{{ url('/admin/add_question') }}" class="btn btn-light-warning font-weight-bolder btn-sm">Add New</a>
							</div>
						</div>
					</div>
					<!--begin::Form-->
					<form class="form" action="{{url('savequestions')}}" method="post">
						<div class="card-body">
							...
							<div class="form-group">
								...
								<div class="btn-group" role="group">
									...
									<div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
										@if($roles)
										@foreach($roles as $row)
										<a class="dropdown-item" href="{{ url('admin/show_question/'.$row->id) }}">{{$row->name}}</a>
								...
								<table class="table mb-5">
									...
									<tbody>@if($quesdata)
										...
										<tr>
											...
											<td>
												<a href="{{url('/admin/edit-questions/'.$data->id)}}"><span class="svg-icon svg-icon-primary svg-icon-2x">
												...
												<!-- <img src="{{'public/assets/media/svg/icons/General/Trash.svg'}}"/> -->
												 <a href='../delete_question/{{ $data->id }}'><span class="svg-icon svg-icon-danger svg-icon-2x">
