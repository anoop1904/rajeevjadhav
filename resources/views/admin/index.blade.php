		...
		<div class="col-xl-4">
			...
			<div class="card card-custom bg-light-success card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{ $totalcustomer }}</span>
		...
		<div class="col-xl-4">
			...
			<div class="card card-custom bg-light-danger card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{$paidcust}}</span>
		...
		<div class="col-xl-4">
			...
			<div class="card card-custom bg-light-warning card-stretch gutter-b">
				...
				<div class="card-body">
					...
					<span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">${{$gross}}</span>
		...
		<table class="table table-striped table-bordered table-responsive-sm dataTable" id="example_contra">
			...
			<tbody>
				...
				<tr>	
					...
					<td><i class="fa fa-user text-primary mr-2"></i>{{$data->first_name}} {{$data->last_name}} <br><br> <i class="fa fa-envelope text-primary mr-2"></i>{{$data->emailId}} <br><br> <i class="fa fa-phone text-primary mr-2"></i>{{$data->contact}} </td>
					<td><strong class="text-primary">Package - </strong>  {{$data->name}} <br><br> <strong class="text-primary">Added at - </strong> {{$data->added_at}} <br><br><strong class="text-primary">Que Remain - </strong> {{$data->remaining_ques}}</td>
