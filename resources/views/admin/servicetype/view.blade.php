					...
					<div class="card-header">
						...
						<div class="card-toolbar">
							<div class="example-tools justify-content-center">
								<a href="{{url('admin/add-serviceType')}}" class="btn btn-light-warning font-weight-bolder btn-sm">Add New</a>
							</div>
						</div>
					</div>
					<!--begin::Form-->
						...
						@endif
							...
							<div class="form-group">
								<table class="table mb-5">
									...
									<tbody>@if($quesdata)
										@foreach($quesdata as $key=>$data)
										<tr>
											<th scope="row">{{$key+1}}</th>
											@if($data->coach_id==1)
											 <td><span class="font-weight-bold text-success">Spiritual Type</span></td>
											 <td><span class="font-weight-bold text-success">{{$data->ques}}</span></td>
											 
											 @elseif($data->coach_id==2)
											 <td><span class="font-weight-bold text-primary">Business Type</span></td>
											 <td><span class="font-weight-bold text-primary">{{$data->ques}}</span></td>
											 @else
											 <td>Other Type</td>
											  <td>{{$data->ques}}</td>
											 @endif
											...
											<td>
												<!-- <a href="../edit-questions/{{ $data->id }}"><span class="svg-icon svg-icon-primary svg-icon-2x"> -->
														...
														<!--end::Svg Icon-->
												<!-- </span></a> -->
												<!-- <img src="{{'public/assets/media/svg/icons/General/Trash.svg'}}"/> -->
												<a href="{{url('admin/delete-serviceType/'. $data->id)}}"><span class="svg-icon svg-icon-danger svg-icon-2x">
