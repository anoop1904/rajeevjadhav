    ...
    <div class="container">
        ...
        <div class="services-lists mt-5">
            <div class="service-list-box bg-dark wow fadeInUp">
                <div class="service-images-list-right"><img src="{{ asset('public/front/images/soulmate.png') }}"></div>
                <div class="service-list-text-right">
                    ...
                    <div>
                        ...
                        <a href="{{url('/service-details-soulmate')}}" class="btn btn-primary">Read More</a>
                </div>
                </div>
                </div>
            </div>
            ...
            <div class="service-list-box wow fadeInUp">
                <div class="service-images-list-left"><img src="{{ asset('public/front/images/Influencer.png') }}"></div>
                <div class="service-list-text-left">
                    ...
                    <a href="{{url('/service-details-influencer')}}" class="btn btn-primary">Read More</a>
                    </div>
                    </div>
                </div>
            </div>
            ...
            <div class="service-list-box bg-dark wow fadeInUp">
                <div class="service-images-list-right"><img src="{{ asset('public/front/images/business.png') }}"></div>
                <div class="service-list-text-right">
                    <div class="d-flex align-items-center">
                    <div class="align-self-center">
                        ...
                        <a href="{{url('/service-details-business')}}" class="btn btn-primary">Read More</a>
                </div>
                </div>
                </div>
            </div>
            ...
            <div class="service-list-box wow fadeInUp">
                <div class="service-images-list-left"><img src="{{ asset('public/front/images/corporate-coaching.png') }}"></div>
                <div class="service-list-text-left">
                    <div class="d-flex align-items-center">
                        <div class="align-self-center">
                    <h3>CORPORATE COACHING</h3>
                    <p>Need help in elevating your team’s performance or elevating your team’s profile at work? </p>
                    <a href="{{url('/service-details-corporate')}}" class="btn btn-primary">Read More</a>
                    </div>
                    </div>
                </div>
            </div>
            ...
            <div class="service-list-box bg-dark wow fadeInUp">
                <div class="service-images-list-right"><img src="{{ asset('public/front/images/private-coaching.png') }}"></div>
                <div class="service-list-text-right">
                    <div class="d-flex align-items-center">
                    <div class="align-self-center">
                        <h3>PRIVATE COACHING</h3>
                        <p>Need help in elevating your  performance or elevating your  profile at work?</p>
                        <a href="{{url('/service-details-private')}}" class="btn btn-primary">Read More</a>
                </div>
                </div>
                </div>
            </div>
            ...
            <div class="service-list-box wow fadeInUp">
                <div class="service-images-list-left"><img src="{{ asset('public/front/images/Book-Me-1a.png') }}"></div>
                <div class="service-list-text-left">
                    <div class="d-flex align-items-center">
                        <div class="align-self-center">
                    <h3>BOOK ME</h3>
                    ...
                    <a href="{{url('/bookme')}}" class="btn btn-primary">Read More</a>
                    </div>
                    </div>
                </div>
            </div>
