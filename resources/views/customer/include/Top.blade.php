...
<link rel="icon" type="image/x-icon" href="{{ asset('public/front/favicon.ico') }}">
...
<header class="shadow-sm sticky-top">
        ...
        <div class="d-flex">
            ...
            <div class="flex-grow-1">
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <a class="navbar-brand" href="{{url('/')}}"><img src="{{ asset('public/front/images/logo.png') }}"/></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active">
                          ...
                          <a class="nav-link {{Request::segment(1) == '' ? 'cus_menu' : ''}}" href="{{url('/')}}">Home</a>
                        ...
                        <li class="nav-item">
                          ...
                          <a class="nav-link {{Request::segment(1) == 'about' ? 'cus_menu' : ''}}" href="{{url('/about')}}">About Us</a>

                        </li>

                        <li class="nav-item">

                            <a class="nav-link {{Request::segment(1) == 'services' ? 'cus_menu' : ''}}" href="{{url('/services')}}">Services</a>

                          </li>

                          <li class="nav-item">

                            <a class="nav-link {{Request::segment(1) == 'testimonials' ? 'cus_menu' : ''}}" href="{{url('/testimonials')}}">Testimonials</a>

                          </li>

                          <li class="nav-item">

                            <a class="nav-link {{Request::segment(1) == 'contact' ? 'cus_menu' : ''}}" href="{{url('/contact')}}">Contact</a>
            ...
            <div class="btn-group">
              <div class="notification-box" class="dropdown-toggle" data-toggle="dropdown"><a href="#"><i class="fa fa-bell">   
                <span class="notif-count1" id="front_noti" style="position: relative;">  
                  ...
                  @endphp	   
                  @foreach( $customer_questions as $key=>$customer_questions ) @endforeach  
                  @if($key == 0)  
                  <span style="display:block; background:red; color:#ffffff; width: 20px; height:20px; position:absolute; top:-18px; right:-12px; border-radius:50%; font-size:12px;line-height:20px"> {{ 1 }} </span>											
  
                  @elseif($key > 0)  
                  <span style="display:block; background:red; color:#ffffff; width: 20px; height:20px; position:absolute; top:-18px; right:-12px; border-radius:50%; font-size:12px;line-height:20px"> {{ $key+1 }} </span>	
                    @endif  
                ...
                <div class="dropdown-menu dropdown-menu-right" style="width:250px;">
                  ...
                  <div class="p-2 text-center" id="notify_area">
                   <div class="p-1">
                    ...
                    <button id="{{ $response->id }}" onclick="customer_notification_update(id)" class="btn btn-light text-warning">Unread</button>
                  </div>
 ...
 {{-- -----------------------notification----------------------- --}}
            ...
            <div class="user-dropdown">
              <div class="btn-group">
                  <button type="button" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="{{asset('public/front/images/user-pic.png')}}"/>
                  </button>
                  <div class="dropdown-menu dropdown-menu-right">
                      <a class="dropdown-item" href="{{url('/customer/pfofile')}}"><i class="icon-user icons"></i> My Profile</a>
                      <a class="dropdown-item" href="{{url('/customer/response')}}"><i class="icon-envelope icons"></i> Responses</a>
                      <a class="dropdown-item" href="{{url('/customer/creadit')}}"><i class="fa fa-usd"></i> My Credits</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item logout-btn" href="{{url('/customer/logout')}}"><i class="icon-login icons"></i> Logout</a>
                  </div>
                </div>
          </div>
            @else	 
            ...
            <div class="login-btn">
              ...
              <a href="{{url('/customer/login')}}" class="btn btn-primary"><i class="icon-user icons"></i> <span>Login</span></a>
