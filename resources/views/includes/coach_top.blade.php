...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="{{ asset('public/assets/css/themes/layout/header/base/dark.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('public/assets/css/themes/layout/header/menu/dark.css') }}" rel="stylesheet" type="text/css" />
