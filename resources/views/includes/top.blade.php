...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Business Coach | @yield('title')</title>
		...
		<link href="{{ asset('public/assets/css/themes/layout/brand/light.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('public/assets/css/themes/layout/aside/light.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('public/assets/dt/dataTables.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
  ...
  background-color: #1e90ff;
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html2">
				<img alt="Logo" src="{{ asset('public/assets/media/logos/logo-dark.png') }}" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
