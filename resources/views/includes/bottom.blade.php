		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<a href="{{ url('admin/profile/'.$id) }}" class="navi-item">
						<div class="navi-link">
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
						...
						<div class="mb-5" id="anoop_notifications_admin">
							...
							@foreach( $customer_questions as $key=>$customer_questions )
							<!--begin: Item-->
							<div class="d-flex align-items-center bg-light-warning rounded p-5 mb-5">
								...
								<div class="d-flex flex-column flex-grow-1 mr-2">
									<a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">{{ $customer_questions->question_check }}</a>
									<span class="text-muted font-size-sm">You have a new question</span>
								</div>
								<button id="{{ $customer_questions->id }}" onclick="update_notification(id)" class="btn btn-light font-weight-bolder text-warning py-1 font-size-lg">Unread</button>
							</div>
							<!--end: Item-->
							@endforeach
		...
		<script src="{{ asset('public/assets/js/pages/widgets.js') }}"></script>
			<script src="{{ asset('public/assets/dt/jquery.dataTables.min.js') }}"></script>
		<script src="{{ asset('public/assets/dt/dataTables.bootstrap4.min.js') }}"></script>
		...
		<script>
			...
			function update_notification(id) {
				...
				$.ajax({
					type: 'POST',
					url: "{{ url('/admin/edit_question_status') }}",
					data: {
