...
$("input[name='call_m']").click(function() {
    ...
    if ($(this).val() === 'yes') {
        $('#redirect_btn_area').show();
        $('#submit_btn_area').hide();
    }

    if ($(this).val() === 'done') {
        $('#redirect_btn_area').hide();
        $('#submit_btn_area').show();

    }
    if ($(this).val() === 'yes' || $(this).val() === 'done') {
        $('#with_id').show();
    } else {
        $('#with_id').hide();
    }
...
//     window.location.href = base_url + '/rajeev/discover_page';
// });
...
$("input[name='payment_radio']").click(function() {
    // alert('fdsfsdf');
    if ($(this).val() === 'pay_with_paypal') {
        $('#proceed_payment').hide();
        $('#proceed_wallet').hide();
        $('#proceed_paypay').show();
    }
    if ($(this).val() === 'pay_with_vallet') {
        $('#proceed_payment').hide();
        $('#proceed_paypay').hide();
        $('#proceed_wallet').show();
    }
