                        ...
                        <div class="d-flex align-items-start list-item card-spacer-x py-3" data-inbox="message">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center mr-3" data-inbox="actions">
                                    ...
                                    <a href="#" class="btn btn-icon btn-xs text-hover-warning active" data-toggle="tooltip" data-placement="right" title="" data-original-title="Delete customer">
                                ...
                                <div class="d-flex align-items-center flex-wrap w-xxl-200px mr-3" data-toggle="view">
                                    <div class="symbol symbol-light-danger symbol-35 mr-3">
                                        <span class="symbol-label font-weight-bolder"><?php echo e($key+1); ?></span>
                                    </div>
                            ...
                            <div class="flex-grow-1 mt-2 mr-2" data-toggle="view">
                                <div>
                                    <span class="font-weight-bolder font-size-lg mr-2"><?php echo e($data->first_name); ?> <?php echo e($data->last_name); ?></span>
                                    <span class="text-muted"><i class="fa fa-envelope text-primary mr-2"></i> <?php echo e($data->emailId); ?>  </span>
                                    <span class="text-muted"><i class="fa fa-phone text-primary mr-2"></i><?php echo e($data->contact); ?> </span>
                                ...
                                <div class="mt-2">
                                    <div class="d-flex flex-column">
                                        <div class="toggle-off-item">
                                                ...
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($data->added_at); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted py-2">Que Remain </td>
                                                            <td> <?php echo e($data->remaining_ques); ?></td>
                                                        </tr>
                                                        <!-- <tr>
                                            ...
                                            <a class="btn btn-sm btn-icon btn-bg-light btn-icon-danger btn-hover-danger" href="#" data-toggle="modal" data-target="#kt_<?php echo e($data->user_id); ?>">
                            ...
                            <!--end::Info-->
                            <!--begin::Datetime-->
                            <div class="mt-2 mr-3 font-weight-bolder w-100px text-right" data-toggle="view"><?php echo e($data->added_at); ?></div>
                            <!--end::Datetime-->
                        </div>
                        <!--end::Item-->                        

                        <div class="modal modal-sticky  show" id="kt_<?php echo e($data->user_id); ?>" role="dialog" data-backdrop="false" aria-modal="true" style="padding-right: 17px; display: none;">
                                    ...
                                    <div class="card card-custom">
                                        ...
                                        <div class="card-header align-items-center px-4 py-3">
                                            ...
                                            <div class="text-center flex-grow-1">
                                                ...
                                                <div class="text-dark-75 font-weight-bold font-size-h5"><?php echo e($data->first_name); ?> <?php echo e($data->last_name); ?></div>
                                                <!-- <div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="scroll scroll-pull ps ps--active-y" data-height="375" data-mobile-height="300" style="height: 375px; overflow: hidden;">
                                                ...
                                                <?php if($uQA->user_id==$data->user_id): ?>
                                                ...
                                                <div class="messages">
                                                    ...
                                                    <div class="d-flex flex-column mb-5 align-items-start">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                <a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6"><?php echo e($data->first_name); ?> <?php echo e($data->last_name); ?></a>
                                                                <span class="text-muted font-size-sm"><?php echo e($uQA->added_at); ?></span>
                                                            </div>
                                                        </div>

                                                        <div class="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold font-size-lg text-left max-w-400px"><?php echo e($uQA->ques); ?></div>
                                                    </div>
                                                    <!--end::Message In-->
                                                    <!--begin::Message Out-->
                                                    ...
                                                    <div class="d-flex flex-column mb-5 align-items-end">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="text-muted font-size-sm"><?php echo e($uQA->ans_at); ?></span>
                                                        ...
                                                        <?php if($uQA->answer!=''): ?>
                                                        <div class="mt-2 rounded p-5 bg-light-primary text-dark-50 font-weight-bold font-size-lg text-right max-w-400px"><?php echo e($uQA->answer); ?></div>
                                                        <?php else: ?>
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\rajeevjadhav\resources\views/admin/customer/customers.blade.php ENDPATH**/ ?>