			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('<?php echo e(asset('public/assets/media/users/300_21.jpg')); ?>')"></div>
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
						...
						<div class="mb-5" id="anoop_notifications_admin">
							...
							<?php
							$coaches = DB::table('coaches')->where('status', '0')->orWhere('status', '0,2')->orderBy('id', 'desc')->get()->toArray();
							$key = -1;
							?>

							<?php $__currentLoopData = $coaches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$coach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<!--begin: Item-->
							<div class="d-flex align-items-center bg-light-warning rounded p-5 mb-5">
								...
								<div class="d-flex flex-column flex-grow-1 mr-2">
									<a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1"><?php echo e('Hi ' .$coach->name); ?></a>
									<span class="text-muted font-size-sm">You are register as a coach</span>
								</div>
								<button id="<?php echo e($coach->id); ?>" onclick="update_notification(id)" class="btn btn-light font-weight-bolder text-warning py-1 font-size-lg">Unread</button>
							</div>
							<!--end: Item-->
		...
		<script>
			...
			function update_notification(id) {
				...
				$.ajax({
					type: 'POST',
					url: "<?php echo e(url('admin/edit_coach')); ?>",
					data: {
	...
	<!--end::Body-->
</html><?php /**PATH C:\xampp8\htdocs\rajeevjadhav\resources\views/includes/bottom.blade.php ENDPATH**/ ?>