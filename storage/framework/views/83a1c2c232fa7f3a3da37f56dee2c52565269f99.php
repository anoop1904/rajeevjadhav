            ...
            <div class="service-list-box bg-dark wow fadeInUp">
                ...
                <div class="service-list-text-right">
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(url('/service-details')); ?>" class="btn btn-primary">Read More</a>
                </div>
                </div>
                </div>
            </div>
            ...
            <div class="service-list-box bg-dark wow fadeInUp">
                ...
                <div class="service-list-text-right">
                    ...
                    <div class="align-self-center">
                        ...
                        <p>Have an idea but unclear how to make it a business? We help you start or grow your business</p>
                        <a href="services-details.html" class="btn btn-primary">Read More</a>
                </div>
                </div>
                </div>
            </div>
...
<?php echo $__env->make('front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\rajeevjadhav\resources\views/customer/services.blade.php ENDPATH**/ ?>