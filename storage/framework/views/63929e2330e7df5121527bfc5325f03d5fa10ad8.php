...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <input class="form-control form-control-lg form-control-solid" type="password" name="password_confirmation" value="">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <input class="form-control form-control-lg form-control-solid" type="text" name="phone" value="<?php echo e(old('phone')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <input type="text" class="form-control form-control-lg form-control-solid" name="email" value="<?php echo e(old('email')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <input class="form-control form-control-lg form-control-solid" type="text" name="qualification" value="<?php echo e(old('qualification')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <input class="form-control form-control-lg form-control-solid" type="text" name="expertise" value="<?php echo e(old('expertise')); ?>">
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\rajeevjadhav\resources\views/admin/coach/add.blade.php ENDPATH**/ ?>