                ...
                <div class="login-signup">
                    ...
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group mb-5">
                            <input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Fullname" name="name" id="name" value="<?php echo e(old('name')); ?>" required autofocus autocomplete="off"  />
                        </div>   
                        <div class="form-group mb-5">
...
<?php echo $__env->make('includes.bottom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\rajeevjadhav\resources\views/auth/register.blade.php ENDPATH**/ ?>