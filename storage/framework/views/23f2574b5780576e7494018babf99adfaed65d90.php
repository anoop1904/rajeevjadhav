                                    ...
                                    <div class="timeline-items">
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <?php $userPckg =
                                                DB::table('user_package')->where('user_id',$data->id)->orderBy('added_at','Desc')->get()->toArray();
                                                ?>
                                                <?php if( $userPckg): ?>
                                                ...
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($p->name); ?>  </td><td  style="position:absolute; right:20px;"><?php echo e(date("d-m-Y h:m:s", strtotime($p->added_at))); ?></td>
                                                ...
                                                <table class="mb-4">
                                                    <tr>
                                                        ...
                                                        <td><?php if($uQA->fname != ""): ?>
                                                            ...
                                                            <p>Partner Name : <?php echo e($uQA->partner_fname); ?>

                                                                <?php echo e($uQA->partner_lname); ?></p> -->
                                                            <?php endif; ?>
                                                            
                                                            <p><?php echo e($uQA->question_check); ?> <?php echo e(date("d-m-Y h:m:s", strtotime($uQA->created_at))); ?></p>

                                                        </td>
                                                        
                                                        <?php if($uQA->packg_for == 1): ?>
                                        
                                                         <?php else: ?>
                                                                       <td>
                                                            <?php if($uQA->status == 0): ?>
                                                          <p>  <a href="<?php echo e(url('coach/response/'.$uQA->id)); ?>"
                                                                class="btn btn-outline-danger"
                                                                style="position:absolute; right:20px;">Response</a></p>
...
<?php echo $__env->make('coach_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/coach/index.blade.php ENDPATH**/ ?>