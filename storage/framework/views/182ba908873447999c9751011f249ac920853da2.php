...
<?php $__env->startSection('bc', 'About Us'); ?>
    ...
    <div class="container">
        ...
        <div class="about-section">
            <div class="row wow fadeInUp">
                <div class="col-lg-5">
                    <img src="<?php echo e(asset('public/front/images/Rajiv-Aurora.jpg')); ?>" class="img-fluid"/>
                </div>
                <div class="col-lg-7">
                    ...
                    <div class="text-right"><a href="<?php echo e(url('/contact')); ?>" class="btn btn-primary">Work With Me</a></div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/customer/about.blade.php ENDPATH**/ ?>