					...
					<div class="card-header">
						...
						<div class="card-toolbar">
							<div class="example-tools justify-content-center">
								<a href="<?php echo e(url('/admin/add-promocode')); ?>"class="btn btn-light-warning font-weight-bolder btn-sm">Add New</a>
							</div>
						</div>
					</div>
					<!--begin::Form-->
					<form class="form" >
                        ...
                        <?php endif; ?>
								...
								<table class="table mb-5">
									...
									<tbody><?php if($data): ?>
										<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$pdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											<th scope="row"><?php echo e($key+1); ?></th>
										
											<td><?php echo e($pdata->name); ?></td>
											<td><?php echo e($pdata->amount); ?> <?php echo e($pdata->type); ?></td>
                                            <td><?php echo e($pdata->startdate); ?></td>
                                            <td><?php echo e($pdata->enddate); ?></td>

											
											<td>
												<a href='edit-promocode/<?php echo e($pdata->id); ?>'><span class="svg-icon svg-icon-primary svg-icon-2x">
												...
												|<a href='delete-promocode/<?php echo e($pdata->id); ?>'><span class="svg-icon svg-icon-danger svg-icon-2x">
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/admin/promocode/promocode.blade.php ENDPATH**/ ?>