...
<title>Rajive Jadhav</title>
<meta name=viewport content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
<link rel="icon" type="<?php echo e(asset('public/front/image/x-icon')); ?>" href="favicon.ico">
...
::-moz-selection {background: #F15A24;color:#fff;}
</style>
</head>
<body>
            ...
            <div class="col-lg-12">
				...
				<div class="card">
                    <div class="card-header">
                        <h2 class="text-danger">Oops ! 404 Error</h2>
                    </div>
                    <div class="card-body text-center">
                        <hr class="w-25">
                        <h1 class="text-center">Page not found</h1>
                        <hr class="w-25">
                        <a href="<?php echo e(url('/')); ?>" class="btn btn-danger">Go to Homepage</a>
                    </div>
				</div>
...
<footer class="wow fadeInUp">
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-6">
                <div class="footer-col mb-3 left-col pr-md-5">
                    <a href="#">MEDIA INQUIRIES ></a>
                    <p class="mb-3">Bright Now Inc. has a dedicated media department. Members of the press are welcome to contact us regard…</p>
            ...
            <div class="col-12 col-md-12 col-lg-3">
                <div class="footer-col mb-3">
                    <h4>BRIGHT NOW INC.</h4>
                    <p>99 Wall St, Ste.1303, New York
                        NY 10005</p>
    ...
    <div class="footer-bottom text-center">
        © 2021 Robbins Research International, Inc. All rights reserved.
    </div>
</footer>
...
</html><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/welcome.blade.php ENDPATH**/ ?>