                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex justify-content-between flex-wrap mt-1">
                        ...
                        <div class="my-lg-0 my-3">
                           <a href="<?php echo e(url('admin/editadmin_profile/'.$profile->id)); ?>" class="btn btn-sm btn-info font-weight-bolder text-uppercase">Edit Profile</a>
                        </div>
                    </div>
                    <!--end::Title-->
                    <!--begin::Content-->
                    <div class="d-flex flex-wrap justify-content-between mt-1">
                        <div class="d-flex flex-column flex-grow-1 pr-8">
                            <div class="d-flex flex-wrap mb-4">
                                ...
                                <a href="#" class="text-dark-50 text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
                                <i class="fa fa-phone text-primary mr-2"></i></i><?php echo e($profile->phone); ?></a>
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/admin/profile.blade.php ENDPATH**/ ?>