			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
					    	<?php  @$photo =Auth::guard('coach')->user()->photo ;
					    	@$email =Auth::guard('coach')->user()->email ;
				    	$path = 'storage/app/coach/profile/'.$photo;   
				    	?>
					...
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
						    	<?php if(Auth::guard('coach')->user()->name): ?>
								<?php echo e(@$name = Auth::guard('coach')->user()->name); ?>

							<?php endif; ?>
							</a>
						<div class="text-muted mt-1"><?php echo e($email); ?></div>
						<div class="navi mt-2">
							<form method="POST" action="<?php echo e(route('coach_logout')); ?>">
								<?php echo csrf_field(); ?>
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<a href="<?php echo e(url('/coach/profile/'.$id)); ?>" class="navi-item">
						<div class="navi-link">
			...
			<div class="offcanvas-content px-10">
				<div class="tab-content">
					...
					<div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
							<!--begin::Section-->
						<div class="mb-5" id="anoop_notifications_coach">
		...
		<script>
			function anoop_notification() {
				...
				$("#anoop_notifications_coach").load(window.location.href + " #anoop_notifications_coach");
			}
		...
		</html><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/includes/coach_bottom.blade.php ENDPATH**/ ?>