								...
								<?php if(Route::has('login')): ?>
										...
										<?php else: ?>										
											...
											<a href="<?php echo e(url('/admin')); ?>" class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2">										
												<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline my-3">to Admin</span>									
											</a>
											</div>									
										<?php endif; ?>								
								<?php endif; ?>
...
<?php echo $__env->make('includes.bottom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\rajeevjadhav\resources\views/admin/coach/login.blade.php ENDPATH**/ ?>