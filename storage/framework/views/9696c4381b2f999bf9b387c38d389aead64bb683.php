...
<?php $__env->startSection('bc', $bc); ?>

<?php $__env->startSection('link', 'service-details'); ?>
...
<div class="details-slider owl-carousel">
  ...
  <div class="item">
    ...
    <img src="<?php echo e(asset('public/front/images/inner-1.jpg')); ?>"/>

  </div>

  <div class="item">

    <img src="<?php echo e(asset('public/front/images/inner-2.jpg')); ?>"/>
    ...
    <div class="container">
        ...
        <div class="service-details my-5 wow fadeInUp">
            ...
            <div class="s-d-top bg-dark">
                ...
                <div class="col-12 col-md-4 order-lg-last"><img src="<?php echo e(asset('public/front/images/talking-audience.png')); ?>" class="w-100"/></div>
          ...
          <div class="fearturedin wow fadeInUp mt-5">
            ...
            <div class="mt-5 videosection bg-dark">
             ...
             <?php if(Request::segment(1) == 'service-details-soulmate'): ?>
            ...
            <div class="s-d-top bg-dark fadeInUp">
                ...
                <div class="col-12 col-md-4"><img src="<?php echo e(asset('public/front/images/concept.png')); ?>" class="w-100"/></div>
...
<section class="sechule-call-btn mt-5 wow fadeInUp">
    ...
    <div class="container">
        ...
        <a href="<?php echo e(url('/schedule-call')); ?>" class="btn btn-secondary"><i class="fa fa-long-arrow-right arrow-moving2"></i> Schedule your call</a>
...
<?php echo $__env->make('front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/customer/services-details.blade.php ENDPATH**/ ?>