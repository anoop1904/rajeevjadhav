...
<div class="hero-section wow fadeInUp">
    <div class="container-fluid">
        <div class="hero-slider owl-carousel">
            <div class="item">
                <div class="hero-slides-img"><img src="<?php echo e(asset('public/front/images/slide1.jpg')); ?>"/></div>
            ...
            <div class="item">
                <div class="item">
                    <div class="hero-slides-img"><img src="<?php echo e(asset('public/front/images/slide2.jpg')); ?>"/></div>
                    <div class="hero-slides-text">
            ...
            <div class="item">
                <div class="item">
                    <div class="hero-slides-img"><img src="<?php echo e(asset('public/front/images/slide3.jpg')); ?>"/></div>
                    <div class="hero-slides-text">
            ...
            <div class="item">
                <div class="item">
                    <div class="hero-slides-img"><img src="<?php echo e(asset('public/front/images/slide4.jpg')); ?>"/></div>
                    <div class="hero-slides-text">
            ...
            <div class="item">
                <div class="item">
                    <div class="hero-slides-img"><img src="<?php echo e(asset('public/front/images/slide5.jpg')); ?>"/></div>
                    <div class="hero-slides-text">
    ...
    <div class="container">
        ...
        <div class="testimonials-slider mt-4 owl-carousel">
             <?php $testimonial = DB::table('testimonial')->orderBy('descrp','Desc')->get()->toArray(); ?>
             <?php $__currentLoopData = $testimonial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$testim1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <?php if($testim1->link): ?>
             <?php elseif($testim1->video): ?>
             <?php else: ?>
            <div class="item">
                <div class="testimonials-box">
                    <div class="user-image"><img src="<?php echo e(url('storage/app/'.$testim1->photo)); ?>"/></div>
                    <h3><?php echo e($testim1->name); ?></h3>
                    <i><?php echo e($testim1->design); ?></i>
                    <div class="quotebox"><i class="fa fa-quote-left"></i></div>
                    <p> <?php echo e($testim1->descrp); ?></p>
                </div>
            </div>
            <?php endif; ?>
            ...
            <!--<div class="item">-->
            <!--    <div class="testimonials-box">-->
            <!--        <div class="user-image"><img src="<?php echo e(asset('public/front/images/Picture13.jpg')); ?>"/></div>-->
            <!--        <h3>Luis Guaman</h3>-->
            ...
            <!--<div class="item">-->
            <!--    <div class="testimonials-box">-->
            <!--        <div class="user-image"><img src="<?php echo e(asset('public/front/images/Picture22.jpg')); ?>"/></div>-->
            ...
            <!--<div class="item">-->
            <!--    <div class="testimonials-box">-->
            <!--        <div class="user-image"><img src="<?php echo e(asset('public/front/images/Picture11.jpg')); ?>"/></div>-->
            <!--        <h3>Joe Dec</h3>-->
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4 wow fadeInUp">
                    <div class="services-box">
                        <div class="service-img"><img src="<?php echo e(asset('public/front/images/soulmate.png')); ?>"></div>
                        ...
                        <div class="service-overlal p-3 text-center">
                            ...
                            <a href="<?php echo e(url('/service-details-soulmate')); ?>" class="btn btn-secondary mt-2">Read More</a>
                                </div>
                            </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 wow fadeInDown">
                    <div class="services-box">
                        <div class="service-img"><img src="<?php echo e(asset('public/front/images/Influencer.png')); ?>"></div>
                        <h3>Become an Influencer</h3>
                        <div class="service-overlal p-3 text-center">
                            <div class="d-flex h-100">
                                <div class="align-self-center">
                                    <p>Tired of not been taken seriously by peers? We’ll help you become an Influencer</p>
                                        <a href="<?php echo e(url('/service-details-influencer')); ?>" class="btn btn-secondary mt-2">Read More</a>
                                </div>
                            </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 wow fadeInUp">
                    <div class="services-box">
                        <div class="service-img"><img src="<?php echo e(asset('public/front/images/business.png')); ?>"></div>
                        ...
                        <div class="service-overlal p-3 text-center">
                            <div class="d-flex h-100">
                                <div class="align-self-center">
                                    ...
                                    <a href="<?php echo e(url('/service-details-business')); ?>" class="btn btn-secondary mt-2">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 wow fadeInDown">
                    <div class="services-box">
                        <div class="service-img"><img src="<?php echo e(asset('public/front/images/corporate-coaching.png')); ?>"></div>
                        <h3>CORPORATE COACHING</h3>
                        <div class="service-overlal p-3 text-center">
                            <div class="d-flex h-100">
                                <div class="align-self-center">
                                    <p>Want to be more effective at work and crush your quarterly goals? Lets get started today</p>
                                    <a href="<?php echo e(url('/service-details-corporate')); ?>" class="btn btn-secondary mt-2">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 wow fadeInUp">
                    <div class="services-box">
                        <div class="service-img"><img src="<?php echo e(asset('public/front/images/private-coaching.png')); ?>"></div>
                        ...
                        <div class="service-overlal p-3 text-center">
                            <div class="d-flex h-100">
                                <div class="align-self-center">
                                    ...
                                    <a href="<?php echo e(url('/service-details-private')); ?>" class="btn btn-secondary mt-2">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 wow fadeInDown">
                    <div class="services-box">
                        <div class="service-img"><img src="<?php echo e(asset('public/front/images/Book-Me-1a.png')); ?>"></div>
                        <h3>BOOK ME</h3>
                        <div class="service-overlal p-3 text-center">
                            <div class="d-flex h-100">
                                <div class="align-self-center">
                                    ...
                                    <a href="<?php echo e(url('/bookme')); ?>" class="btn btn-secondary mt-2">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="startnow-section py-5 wow fadeInUp">
        <div class="container">
            <div class="d-md-flex">
                ...
                <div class="start-btn align-self-center"><a href="<?php echo e(url('/customer/google_form')); ?>" class="btn btn-light"><i class="fa fa-long-arrow-right arrow-moving2"></i> Start Now</a></div>
            </div>
        </div>
    </section>
            ...
            <div class="success-con">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4 wow fadeInUp">
                        <div class="services-box">
                            <a href="#">
                                <div class="service-img"><img src="<?php echo e(asset('public/front/images/blog.png')); ?>"></div>
                                <h3>Blog</h3>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 wow fadeInDown">
                        <div class="services-box">
                            <a href="#">
                                <div class="service-img"><img src="<?php echo e(asset('public/front/images/headlines.png')); ?>"></div>
                                <h3>Press</h3>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 wow fadeInUp">
                        <div class="services-box">
                            <a href="#">
                                <div class="service-img"><img src="<?php echo e(asset('public/front/images/media.png')); ?>"></div>
                                <h3>Media Gallery</h3>
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/customer/home.blade.php ENDPATH**/ ?>