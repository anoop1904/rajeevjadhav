    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <form class="form" action="<?php echo e(url('admin/add-promocode')); ?>" method="POST"> 
                <?php echo csrf_field(); ?>
                    <div class="card-body">
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/admin/promocode/addpromocode.blade.php ENDPATH**/ ?>