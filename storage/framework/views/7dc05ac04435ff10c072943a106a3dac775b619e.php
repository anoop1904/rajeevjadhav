				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="<?php echo e(url('/')); ?>" class="brand-logo">
							<img alt="Logo" src="<?php echo e(asset('public/assets/media/logos/logo-light.png')); ?>" style="width: 95%;"/>
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								<li class="menu-item" aria-haspopup="true">
									<a href="<?php echo e(url('/admin')); ?>" class="menu-link <?php echo e((Request::segment(1) == 'admin' && Request::segment(2) == '') ? 'ad_menu' : ''); ?>">
								...
								<li class="menu-item menu-item-submenu <?php echo e((Request::segment(2) == 'show_role' || Request::segment(2) == 'add_role') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/show_role')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'show_role' ? 'ad_menu' : ''); ?>">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/add_role')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'add_role' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
									...
									<li class="menu-item menu-item-submenu <?php echo e((Request::segment(2) == 'serviceType' || Request::segment(2) == 'add-serviceType') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/serviceType')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'serviceType' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/add-serviceType')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'add-serviceType' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
								...
								<li class="menu-item menu-item-submenu <?php echo e((Request::segment(2) == 'package' || Request::segment(2) == 'add-package') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
									...
									<div class="menu-submenu" kt-hidden-height="160">
										...
										<ul class="menu-subnav">									
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/package')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'package' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/add-package')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'add-package' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
								...
								<li class="menu-item menu-item-submenu <?php echo e((Request::segment(2) == 'customers' || Request::segment(2) == 'add-package' || Request::segment(2) == 'coach' || Request::segment(2) == 'create_coach') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
									...
									<div class="menu-submenu" kt-hidden-height="160">
										...
										<ul class="menu-subnav">
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/customerslist')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'customers' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Customers</span>
																						...
																						<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/guestlist')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'customers' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item menu-item-submenu <?php echo e((Request::segment(2) == 'coach' || Request::segment(2) == 'create_coach') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
												<a href="javascript:;" class="menu-link menu-toggle">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
												...
												<div class="menu-submenu" kt-hidden-height="120">
													...
													<ul class="menu-subnav">
														<li class="menu-item" aria-haspopup="true">
															<a href="<?php echo e(url('/admin/coach')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'coach' ? 'ad_menu' : ''); ?>">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
														...
														<li class="menu-item" aria-haspopup="true">
															<a href="<?php echo e(url('/admin/create_coach')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'create_coach' ? 'ad_menu' : ''); ?>">
																<i class="menu-bullet menu-bullet-dot">
																	<span></span>
																</i>
								...
								<li class="menu-item menu-item-submenu <?php echo e((Request::segment(2) == 'question' || Request::segment(2) == 'add_question') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/question')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'question' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">View Question</span>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/add_question')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'add_question' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Add Question</span>
								...
								<li class="menu-item menu-item-submenu <?php echo e((Request::segment(2) == 'promocode' || Request::segment(2) == 'add-promocode') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('admin/promocode')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'promocode' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/add-promocode')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'add-promocode' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
								...
								<li class="menu-section">
									...
									<li class="menu-item menu-item-submenu <?php echo e((Request::segment(2) == 'testimonial' || Request::segment(2) == 'add-testimonial') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('admin/testimonial')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'testimonial' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo e(url('/admin/add-testimonial')); ?>" class="menu-link <?php echo e(Request::segment(2) == 'add-testimonial' ? 'ad_menu' : ''); ?>">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Add Testimonial</span>
																	...
																	<li class="menu-item menu-item-submenu <?php echo e((Request::segment(2) == 'testimonial' || Request::segment(2) == 'add-testimonial') ? 'menu-item-open' : ''); ?>" aria-haspopup="true" data-menu-toggle="hover">
									<a href="<?php echo e(url('admin/contactus')); ?>" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
				...
				<!--end::Aside--><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/includes/aside.blade.php ENDPATH**/ ?>