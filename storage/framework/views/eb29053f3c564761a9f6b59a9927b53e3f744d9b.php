					...
					<div class="card-header">
						...
						<div class="card-toolbar">
							<div class="example-tools justify-content-center">
								<!--<a href="add-role" class="btn btn-light-warning font-weight-bolder btn-sm">Add New</a>-->
							</div>
						</div>
					</div>
					<!--begin::Form-->
					...
					<div class="card-body"> 
						...
						<div class="form-group">
							<table class="table mb-5">
								...
								<tbody>
									<?php $__currentLoopData = $roledata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td>
											<!--<a href='destroyquestions/<?php echo e($data->id); ?>'><span class="svg-icon svg-icon-primary svg-icon-2x">-->
											...
											<a href="<?php echo e(url('admin/delete/'.$data->id)); ?>" onclick="return confirm('Are you sure?')"><span class="svg-icon svg-icon-danger svg-icon-2x">
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/admin/role/showrole.blade.php ENDPATH**/ ?>