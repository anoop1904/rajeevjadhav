                    ...
                    <div class="container">
                        ...
                        <div class="card mb-20">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo e(url('admin/update_coach/'.$profile->id)); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                   <!--begin::Group-->
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/admin/coach/edit_profile.blade.php ENDPATH**/ ?>