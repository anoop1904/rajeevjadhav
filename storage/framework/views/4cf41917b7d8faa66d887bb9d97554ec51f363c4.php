		...
		<table class="table table-striped table-bordered table-responsive-sm dataTable" id="example_contra">
			...
			<tbody>
				...
				<tr>	
					...
					<td class="text-center"> <a href="#" class="btn btn-icon btn-xs text-hover-warning active" data-toggle="tooltip" data-placement="right" title="" data-original-title="Delete customer">
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\rajeevjadhav\resources\views/admin/index.blade.php ENDPATH**/ ?>