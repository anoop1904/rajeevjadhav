		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
				    	...
				    	$path = 'storage/app/admin/profile/'.$photo;   
				    	?>
					...
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">   
							<?php if(@auth()->user()->name): ?>
								<?php echo e(@$name = auth()->user()->name); ?>
						...
						<div class="navi mt-2">							
                            ...
                            <?php echo csrf_field(); ?>                      
							<input class="btn btn-sm btn-primary" type="submit" value="Sign Out">
                        </form>
						</div>
					</div>
				</div>
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<?php  @$id = Auth::user()->id ?>
					<a href="<?php echo e(url('admin/profile/'.$id)); ?>" class="navi-item">
						<div class="navi-link">
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="<?php echo e(asset('public/assets/media/stock-600x400/img-1.jpg')); ?>" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="<?php echo e(asset('public/assets/media/stock-600x400/img-2.jpg')); ?>" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="<?php echo e(asset('public/assets/media/stock-600x400/img-3.jpg')); ?>" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="<?php echo e(asset('public/assets/media/stock-600x400/img-4.jpg')); ?>" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Separator-->
					...
					<div class="d-flex align-items-center justify-content-between py-8">
						...
						<a href="#" class="symbol symbol-70 flex-shrink-0">
							<img src="<?php echo e(asset('public/assets/media/stock-600x400/img-8.jpg')); ?>" title="" alt="" />
						</a>
					</div>
					<!--end::Item-->
				</div>
			...
			<div class="offcanvas-content px-10">
				<div class="tab-content">
					...
					<div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
						<!--begin::Section-->
						<div class="mb-5" id="anoop_notifications_admin">
							...
							<?php $__currentLoopData = $customer_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$customer_questions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<!--begin: Item-->
							<div class="d-flex align-items-center bg-light-warning rounded p-5 mb-5">
								...
								<div class="d-flex flex-column flex-grow-1 mr-2">
									<a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1"><?php echo e($customer_questions->question_check); ?></a>
									<span class="text-muted font-size-sm">You have a new question</span>
								</div>
								<button id="<?php echo e($customer_questions->id); ?>" onclick="update_notification(id)" class="btn btn-light font-weight-bolder text-warning py-1 font-size-lg">Unread</button>
							</div>
							<!--end: Item-->
									...
									<div class="d-flex flex-column mb-5 align-items-start">
										<div class="d-flex align-items-center">
											<div class="symbol symbol-circle symbol-40 mr-3">
												<img alt="Pic" src="<?php echo e(asset('public/assets/media/users/300_12.jpg')); ?>" />
											</div>
											<div>
									...
									<div class="d-flex flex-column mb-5 align-items-end">
										<div class="d-flex align-items-center">
											...
											<div class="symbol symbol-circle symbol-40 ml-3">
												<img alt="Pic" src="<?php echo e(asset('public/assets/media/users/300_21.jpg')); ?>" />
											</div>
										</div>
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo1.png')); ?>" alt="" class="w-100" />
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo2.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo3.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo4.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo5.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo6.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo7.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo8.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo9.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo10.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo11.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo12.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo13.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo14.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo15.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo16.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo17.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo18.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo19.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo20.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo21.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo22.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo23.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo24.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo25.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo26.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo27.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo28.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo29.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
					...
					<div class="overlay rounded-lg mb-8 offcanvas-demo">
						<div class="overlay-wrapper rounded-lg">
							<img src="<?php echo e(asset('public/assets/media/demos/demo30.png')); ?>" alt="" class="w-100" />
						</div>
						<div class="overlay-layer">
							<a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
						</div>
		...
		<script src="<?php echo e(asset('public/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')); ?>"></script>
			<script src="<?php echo e(asset('public/assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js')); ?>"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="<?php echo e(asset('public/assets/js/pages/widgets.js')); ?>"></script>
			<script src="<?php echo e(asset('public/assets/dt/jquery.dataTables.min.js')); ?>"></script>
		<script src="<?php echo e(asset('public/assets/dt/dataTables.bootstrap4.min.js')); ?>"></script>
		<script src="<?php echo e(asset('public/assets/js/pages/crud/forms/editors/ckeditor-classic.js')); ?>"></script>
		<!--end::Page Scripts-->
		<script>
			var avatar1 = new KTImageInput('kt_image_1');
		</script>
		<script>
			function anoop_notification() {
				$("#kt_quick_panel_toggle").load(window.location.href + " #kt_quick_panel_toggle");
				$("#anoop_notifications_admin").load(window.location.href + " #anoop_notifications_admin");
			...
			function update_notification(id) {
				...
				$.ajax({
					type: 'POST',
					url: "<?php echo e(url('/admin/edit_question_status')); ?>",
					data: {
			...
			function delete_coach(id) {
				...
				$.ajax({
					type: 'POST',
					url: "<?php echo e(url('/admin/delete_coach')); ?>",
					data: {
						"_token": $('meta[name="csrf-token"]').attr('content'),	
						"id": id,
						"action" : 'admin',			
		...
		$(document).ready(function() {
				$('#example_contra').DataTable();
			} );
		</script>
	</body>
	<!--end::Body-->
</html><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/includes/bottom.blade.php ENDPATH**/ ?>