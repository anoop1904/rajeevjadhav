					...
					<div class="card-header">
						...
						<div class="card-toolbar">
							<div class="example-tools justify-content-center">
								<a href="<?php echo e(url('admin/add-serviceType')); ?>" class="btn btn-light-warning font-weight-bolder btn-sm">Add New</a>
							</div>
						</div>
					</div>
					<!--begin::Form-->
								...
								<table class="table mb-5">
									...
									<tbody><?php if($quesdata): ?>
										...
										<tr>
											...
											<?php if($data->coach_id==1): ?>
											 <td><span class="font-weight-bold text-success">Spiritual Type</span></td>
											 <td><span class="font-weight-bold text-success"><?php echo e($data->ques); ?></span></td>
											 
											 <?php elseif($data->coach_id==2): ?>
											 <td><span class="font-weight-bold text-primary">Business Type</span></td>
											 <td><span class="font-weight-bold text-primary"><?php echo e($data->ques); ?></span></td>
											 <?php else: ?>
											 <td>Other Type</td>
											...
											<td>
												<!-- <a href="../edit-questions/<?php echo e($data->id); ?>"><span class="svg-icon svg-icon-primary svg-icon-2x"> -->
												...
												<a href="<?php echo e(url('admin/delete-serviceType/'. $data->id)); ?>"><span class="svg-icon svg-icon-danger svg-icon-2x">
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/admin/servicetype/view.blade.php ENDPATH**/ ?>