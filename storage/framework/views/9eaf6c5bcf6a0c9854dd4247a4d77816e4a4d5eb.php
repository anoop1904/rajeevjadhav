			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('public/assets/media/users/300_21.jpg')"></div>
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
						...
						<div class="mb-5" id="anoop_notifications_coach">
							...
							<?php
							$coaches = DB::table('coaches')->where('status', '0')->orWhere('status', '0,1')->orderBy('id', 'desc')->get()->toArray();
							$key = -1;
							?>
		...
		</html><?php /**PATH C:\xampp8\htdocs\rajeevjadhav\resources\views/includes/coach_bottom.blade.php ENDPATH**/ ?>