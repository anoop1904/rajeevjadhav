                                            ...
                                            <div class="scroll scroll-pull ps ps--active-y" data-height="375" data-mobile-height="300" style="height: 375px; overflow: hidden;">
                                                ...
                                                <div class="messages">
                                                    ...
                                                    <div class="d-flex flex-column mb-5 align-items-end">
                                                        ...
                                                        <?php if($uQA->answer!=''): ?>
                                                        <div class="mt-2 rounded p-5 bg-light-primary text-dark-50 font-weight-bold font-size-lg text-right max-w-400px"><?php echo $uQA->answer; ?></div>
                                                        <?php else: ?>
...
<?php echo $__env->make('admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lucky7bet/public_html/rajeevjadhav/resources/views/admin/customer/customers.blade.php ENDPATH**/ ?>